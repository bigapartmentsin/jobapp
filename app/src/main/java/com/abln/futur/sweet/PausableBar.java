...
final class PausableBar extends FrameLayout {
    ...
    public PausableBar(Context context) {
        this(context, null);
    }

    public PausableBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PausableBar(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(jp.shts.android.storiesprogressview.R.layout.pausable_progress, this);
        frontProgressView = findViewById(jp.shts.android.storiesprogressview.R.id.front_progress);
        maxProgressView = findViewById(jp.shts.android.storiesprogressview.R.id.max_progress); // work around
    }
    ...
    void setMinWithoutCallback() {
        maxProgressView.setBackgroundResource(jp.shts.android.storiesprogressview.R.color.progress_secondary);
    ...
    void setMaxWithoutCallback() {
        maxProgressView.setBackgroundResource(jp.shts.android.storiesprogressview.R.color.progress_max_active);
    ...
    private void finishProgress(boolean isMax) {
        if (isMax) maxProgressView.setBackgroundResource(jp.shts.android.storiesprogressview.R.color.progress_max_active);
