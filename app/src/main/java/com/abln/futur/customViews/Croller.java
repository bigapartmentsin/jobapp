...
//        linePaint.setStrokeWidth(indicatorWidth);
    ...
    private void initXMLAttrs(Context context, AttributeSet attrs) {
        ...
        setMax(a.getInt(R.styleable.Croller_max_futur, 25));
        setMin(a.getInt(R.styleable.Croller_min_futur, 1));
        deg = min + 2;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int minWidth = (int) BitmapUtils.convertDpToPixel(160, getContext());
        int minHeight = (int) BitmapUtils.convertDpToPixel(160, getContext());
...
//            canvas.drawLine(x1, y1, x2, y2, linePaint);
            canvas.drawCircle((x1 + x2) / 2, (y1 + y2) / 2, innerradius, linePaint);
