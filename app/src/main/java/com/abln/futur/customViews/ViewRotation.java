...
public class ViewRotation  extends ImageView {
    ...
    private boolean snapToCenterFlag = false;       //variable that determines whether to snap the
    ...
    public void setDivCount(int divCount) {
        ...
        Log.d("DIVCOUNT", String.valueOf(totalRotation));
    }
    ...
    public void setAlternateTopDiv(int newTopDiv) {
        ...
        Log.d("TOPDIV", String.valueOf(newTopDiv));
        ...
        Log.d("POSTION SLECTED", String.valueOf(selectedPosition));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (wheelHeight == 0 || wheelWidth == 0) {
            ...
            ViewRotation.this.setImageBitmap(imageScaled);
            ViewRotation.this.setImageMatrix(matrix);
        }
    }
...
Log.d("ROTATION WHEEL ", String.valueOf(totalRotation));
    }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    Log.d("Action DOWN ", String.valueOf(startAngle));
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    Log.d("Action DOWN MOVING ", String.valueOf(startAngle));

                    if (startAngle > 270 && startAngle < 300 ){

                     //   dispatchTouchEvent(event);
                      //  UIUtility.showToastMsg_withErrorShort(getContext(),"Stop the scrolling ");
                       // return true;
                    ...
                    if (startAngle > 180 && startAngle < 270 ){
                     //   dispatchTouchEvent(event);
                      //  UIUtility.showToastMsg_withErrorShort(getContext(),"Starting the scrolling ");
                       // return true;
